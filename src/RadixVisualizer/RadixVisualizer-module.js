/* Local instance of the RadixVisualizer class. Used in exported functions. */
const localInstance = new RadixVisualizer();
...
/**\
 * Visualizes the binary, octal, decimal, and hexadecimal representations of a number(s).
 * Doesn't require instanciating a RadixVisualizer object.
 * @param {number | number[]} numberArray - A number or array of numbers to visualize.
 * @returns {string[] | string[][]} An array of strings containing the binary, octal, decimal, and hexadecimal representations of a number.
 */
export function visualizeRadix(numberArray) {
  return localInstance.visualize(numberArray);
}

/**
 * Returns an array of the binary, octal, decimal, and hexadecimal representations of a number(s).
 * Doesn't log to console and doesn't require instanciating a RadixVisualizer object.
 * @param {number | number[]} numberArray - A number or array of numbers to visualize.
 * @param {boolean} getTableArray - Whether or not the returned array should contain the preformatted table array with headers or only the radix strings.
 * @returns {string[] | string[][]} An array of strings containing the binary, octal, decimal, and hexadecimal representations of a number.
 */
export function getVisualArray(numberArray, getTableArray = false) {
  localInstance.noLogging();
  localInstance.returnTableArray(getTableArray);
  const visualArray = localInstance.visualize(numberArray);
  localInstance.returnRadixArray();
  localInstance.doLogging();
  return visualArray;
}
